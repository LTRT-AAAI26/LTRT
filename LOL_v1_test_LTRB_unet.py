...
class LOLV1RealDataset(torch.utils.data.Dataset):
...
def test_inference():
    ...
    from LOL_v1_LTRB_unet_mid import LTRB_UNet
    model = load_model(lambda: LTRB_UNet(in_ch=3, out_ch=3, height=128, width=128), "LOL_v1_best_ltrb_unet.pth", device)

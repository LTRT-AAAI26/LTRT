...
def train_pure_unet(model, train_loader, test_loader, device, epochs=300):
    ...
    for epoch in range(epochs):
        ...
        if psnr_val > best_psnr:
            ...
            torch.save(best_model, "LOL_v1_best_pure_unet.pth")
...
if __name__ == "__main__":
    ...
    train_loader = DataLoader(train_dataset, batch_size=4, shuffle=True, num_workers=0) #4
    test_loader = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=0) #2
